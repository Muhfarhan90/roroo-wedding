...
@section('title', 'Daftar Klien - ROROO MUA Admin')
    ...
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
            ...
            <form method="GET" action="{{ route('clients.index') }}" id="filterForm">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-2">
                    ...
                    <div class="relative lg:col-span-5">
                        ...
                        <input type="search" name="search" value="{{ request('search') }}" placeholder="Cari Klien..."
        ...
        <script>
            ...
            function exportPDF() {
                ...
                window.open('{{ route('clients.index') }}?export=pdf&' + params, '_blank');
            }
        </script>
                                ...
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="flex flex-col gap-1 sm:gap-2">
                                        ...
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $client->groom_phone) }}"
                                            ...
                                            class="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 sm:py-2 bg-green-50 text-green-700 rounded-lg text-xs sm:text-sm hover:bg-green-100 transition-colors w-fit">
                                            <span class="material-symbols-outlined text-sm sm:text-base">chat</span>
                                            <span>{{ $client->groom_phone }}</span>
                                        </a>
                                    </div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm text-black">
                                        {{ $client->akad_date ? $client->akad_date->format('M d, Y') : '-' }}
                                    </div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm text-black">
                                        {{ $client->reception_date ? $client->reception_date->format('M d, Y') : '-' }}
                                    </div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
