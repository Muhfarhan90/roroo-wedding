...
@section('title', 'Edit Klien - RORO MUA Admin')
    ...
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="mb-6 md:mb-8">
            <div class="flex items-center gap-4 mb-4">
                <a href="{{ route('clients.index') }}" class="p-2 hover:bg-gray-200 rounded-lg transition-colors">
                    <span class="material-symbols-outlined">arrow_back</span>
                </a>
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-black">Edit Klien</h1>
                    <p class="text-sm md:text-base text-gray-600 mt-1">Perbarui informasi klien {{ $client->bride_name }} &
                        {{ $client->groom_name }}</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('clients.update', $client) }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="bride_name" name="bride_name"
                        value="{{ old('bride_name', $client->bride_name) }}" placeholder="e.g., Jane Doe" required
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors @error('bride_name') border-red-500 @enderror">
                    @error('bride_name')
                ...
                <div>
                    ...
                    <input type="text" id="groom_name" name="groom_name"
                        value="{{ old('groom_name', $client->groom_name) }}" placeholder="e.g., John Smith" required
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors @error('groom_name') border-red-500 @enderror">
                    @error('groom_name')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="bride_phone" name="bride_phone"
                        value="{{ old('bride_phone', $client->bride_phone) }}" placeholder="e.g., 081234567890" required
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors @error('bride_phone') border-red-500 @enderror">
                    @error('bride_phone')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="groom_phone" name="groom_phone"
                        value="{{ old('groom_phone', $client->groom_phone) }}" placeholder="e.g., 081234567890" required
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors @error('groom_phone') border-red-500 @enderror">
                    @error('groom_phone')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="bride_address" name="bride_address" rows="3" placeholder="Jl. Contoh Kec.Contoh Kota Contoh"
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors resize-none @error('bride_address') border-red-500 @enderror">{{ old('bride_address', $client->bride_address) }}</textarea>
                    @error('bride_address')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="groom_address" name="groom_address" rows="3" placeholder="e.g., 456 Oak Ave, Anytown, USA 12345"
                        class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors resize-none @error('groom_address') border-red-500 @enderror">{{ old('groom_address', $client->groom_address) }}</textarea>
                    @error('groom_address')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="bride_parents" name="bride_parents"
                        value="{{ old('bride_parents', $client->bride_parents) }}" placeholder="e.g., Mr. & Mrs. Doe"
                ...
                <div>
                    ...
                    <input type="text" id="groom_parents" name="groom_parents"
                        value="{{ old('groom_parents', $client->groom_parents) }}" placeholder="e.g., Mr. & Mrs. Smith"
                ...
                <div>
                    ...
                    <input type="date" id="akad_date" name="akad_date"
                        value="{{ old('akad_date', $client->akad_date?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="time" id="akad_time" name="akad_time"
                        value="{{ old('akad_time', $client->akad_time) }}"
                ...
                <div>
                    ...
                    <input type="date" id="reception_date" name="reception_date"
                        value="{{ old('reception_date', $client->reception_date?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="time" id="reception_time" name="reception_time"
                        value="{{ old('reception_time', $client->reception_time) }}"
                ...
                <div>
                    ...
                    <input type="time" id="reception_end_time" name="reception_end_time"
                        value="{{ old('reception_end_time', $client->reception_end_time) }}"
            ...
            <div>
                ...
                <textarea id="event_location" name="event_location" rows="2"
                    ...
                    class="w-full px-4 py-3 border-2 border-[#d4b896] rounded-lg focus:border-[#c4a886] focus:outline-none transition-colors resize-none @error('event_location') border-red-500 @enderror">{{ old('event_location', $client->event_location) }}</textarea>
