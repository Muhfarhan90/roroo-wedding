...
@section('title', 'Dashboard - ROROO MUA Admin')
...
@section('content')
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
            ...
            <div class="bg-white border-2 border-[#d4b896] p-6 rounded-xl shadow-lg">
                ...
                <p class="text-3xl font-bold text-black">{{ $totalClients }}</p>
            ...
            <div class="bg-white border-2 border-[#d4b896] p-6 rounded-xl shadow-lg">
                ...
                <p class="text-3xl font-bold text-black">{{ $totalInvoices }}</p>
            ...
            <div class="bg-white border-2 border-[#d4b896] p-6 rounded-xl shadow-lg">
                ...
                <p class="text-3xl font-bold text-black">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p>
    ...
    <script>
        ...
        const invoiceStatusData = @json($invoiceStatus);
