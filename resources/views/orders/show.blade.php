        ...
        <div class="flex flex-col lg:grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6 flex flex-col order-2 lg:order-none">
                ...
                @if (is_array($order->decorations) && count($order->decorations) > 0)
                    <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-2 lg:order-none">
                ...
                @if (isset($order->decorations['kursi_pelaminan']))
                    <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-3 lg:order-none">
                        <h2 class="text-lg font-bold mb-4 text-black">Kursi Pelaminan</h2>
                ...
                @if (isset($order->decorations['warna_tenda']))
                    <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-4 lg:order-none">
                        <h2 class="text-lg font-bold mb-4 text-black">Warna Tenda</h2>
                ...
                <!-- Catatan -->
                @if ($order->notes)
                    <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-5 lg:order-none">
                        <h2 class="text-lg font-bold mb-4 text-black">Catatan</h2>
                        <p class="text-sm text-gray-700 whitespace-pre-wrap bg-yellow-100 p-4 rounded">{{ $order->notes }}
                        </p>
                    </div>
                @endif

                <!-- Item Pesanan -->
                <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-6 lg:order-none">
                ...
                <!-- Status Pembayaran -->
                <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-7 lg:order-none">
                                ...
                                @foreach ($paymentHistory as $payment)
                                    <div class="border-l-4 border-[#d4b896] pl-4 py-2">
                                        <div class="flex justify-between items-start">
                                            ...
                                            <span class="text-sm font-semibold text-black">Rp
                ...
                @if (!$existingInvoice)
                    <!-- Invoice Form -->
                    <div class="mt-6 bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg order-8 lg:order-none">
                ...
                @else
                    ...
                    <div class="mt-6 bg-blue-50 border-2 border-blue-200 rounded-xl p-6 shadow-lg order-8 lg:order-none">
    ...
    <div id="paymentModal"
        ...
        <div class="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl">
            ...
            <form action="{{ route('orders.add-payment', $order) }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="dp_number" class="block text-sm font-semibold text-gray-700 mb-1">Label Pembayaran</label>
                    <input type="text" id="dp_number" name="dp_number"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#d4b896] focus:border-transparent"
                        placeholder="e.g., DP1, DP Awal, Pelunasan" required>
                    <p class="text-xs text-gray-500 mt-1">Anda dapat mengubah label sesuai keinginan</p>
                </div>

                <div>
                    <label for="payment_date" class="block text-sm font-semibold text-gray-700 mb-1">Tanggal
                        Pembayaran</label>
                    <input type="date" id="payment_date" name="payment_date"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#d4b896] focus:border-transparent"
                        required>
                    <p class="text-xs text-gray-500 mt-1">Tanggal saat pembayaran diterima</p>
                </div>
