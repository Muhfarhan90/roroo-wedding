...
@section('title', 'Buat Pesanan Baru - ROROO MUA Admin')
                ...
                <div class="space-y-3 sm:space-y-4 md:space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="decorations[kursi_pelaminan]"
                            value="{{ old('decorations.kursi_pelaminan') }}" placeholder="cth: Sofa, Kursi tungggal"
                    ...
                    <div>
                        ...
                        <input type="text" name="decorations[warna_tenda]"
                            value="{{ old('decorations.warna_tenda') }}" placeholder="cth: Coklat, Abu-abu"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none">
                    </div>
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                <div>
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <span id="gaun_{{ $i }}_filename" class="text-sm text-gray-500">No
                                            file</span>
                                    </div>
                                    <input type="file" id="foto_gaun_{{ $i }}"
                                        name="decorations[foto_gaun_{{ $i }}]" class="hidden"
                                        accept="image/*"
                                        onchange="previewImage(this, 'gaun_{{ $i }}_preview', 'gaun_{{ $i }}_filename')">
                                    <div id="gaun_{{ $i }}_preview" class="hidden">
                                        <img src="" alt="Gaun {{ $i }}"
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4" placeholder="Tulis permintaan tambahan di sini..."
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="payment_status" required
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none">
                            <option value="Belum Lunas" {{ old('payment_status') == 'Belum Lunas' ? 'selected' : '' }}>
                                Belum Lunas</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="payment_notes" id="payment_notes"
                            value="{{ old('payment_notes') }}" placeholder="Catatan untuk pembayaran ini (opsional)"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none">
                    </div>
                </div>
            </div>
