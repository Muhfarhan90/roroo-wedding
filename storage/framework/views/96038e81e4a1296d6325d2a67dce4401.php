...
<head>
    ...
    <title>Detail Pesanan #<?php echo e($order->order_number); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="info-box" style="text-align: center; margin-bottom: 20px;">
        ...
        <div style="font-size: 10px; color: #666; margin-top: 3px;">
            Tanggal: <?php echo e($order->created_at->format('d F Y')); ?>
    ...
    <div class="section">
            ...
            <div class="column-left">
                <div class="info-box">
                    <div class="info-row">
                        ...
                        <div class="info-value"><strong><?php echo e($order->order_number); ?></strong></div>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value"><?php echo e($order->client->bride_phone ?? '-'); ?></div>
                    </div>
                    <div class="info-row">
                        <span class="info-label">HP Pengantin Pria</span>
                        <div class="info-value"><?php echo e($order->client->groom_phone ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="info-box">
                    <div class="info-row">
                        ...
                        <div class="info-value"><strong><?php echo e($order->client->bride_name); ?></strong></div>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Alamat Pengantin Wanita</span>
                        <div class="info-value"><?php echo e($order->client->bride_address ?? '-'); ?></div>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Orang Tua Pengantin Wanita</span>
                        <div class="info-value"><?php echo e($order->client->bride_parents ?? '-'); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="column-right">
                <div class="info-box">
                    <div class="info-row">
                        ...
                        <div class="info-value"><strong><?php echo e($order->client->groom_name); ?></strong></div>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Alamat Pengantin Pria</span>
                        <div class="info-value"><?php echo e($order->client->groom_address ?? '-'); ?></div>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Orang Tua Pengantin Pria</span>
                        <div class="info-value"><?php echo e($order->client->groom_parents ?? '-'); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="info-box">
            <div class="info-row">
                ...
                <div class="info-value"><?php echo e($order->client->event_location ?? '-'); ?></div>
            </div>
            <div class="info-row">
                ...
                <div class="info-value">
                    ...
                    <?php if($order->client->akad_time): ?>
                        - <?php echo e(date('H:i', strtotime($order->client->akad_time))); ?> WIB
                    <?php endif; ?>
                </div>
            </div>
            <div class="info-row">
                ...
                <?php if(is_array($order->items) && count($order->items) > 0): ?>
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-right">Rp <?php echo e(number_format($item['total'] ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr class="total-row">
                        <td colspan="3" class="text-right"><strong>Total</strong></td>
                        <td class="text-right"><strong>Rp
                                <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></strong></td>
                    </tr>
                <?php else: ?>
                    <tr>
        ...
        <div class="section">
            ...
            <?php if(isset($order->decorations['photo_pelaminan']) && is_string($order->decorations['photo_pelaminan'])): ?>
                ...
                <div class="info-box">
                    ...
                    <div style="text-align: center; margin-top: 10px;">
                        <img src="<?php echo e(public_path('storage/' . $order->decorations['photo_pelaminan'])); ?>" 
                             alt="Model Pelaminan" 
                    ...
                    <?php if(isset($order->decorations['kursi_pelaminan'])): ?>
                        <div class="info-value" style="margin-top: 10px; text-align: center;">
                            <strong>Kursi:</strong> <?php echo e($order->decorations['kursi_pelaminan']); ?>
            ...
            <?php if(isset($order->decorations['photo_kain_tenda']) && is_string($order->decorations['photo_kain_tenda'])): ?>
                ...
                <div class="info-box">
                    ...
                    <div style="text-align: center; margin-top: 10px;">
                        <img src="<?php echo e(public_path('storage/' . $order->decorations['photo_kain_tenda'])); ?>" 
                             alt="Kain Tenda" 
                             class="decoration-image"
                             style="max-width: 250px;">
                    </div>
                    <?php if(isset($order->decorations['warna_tenda'])): ?>
                        <div class="info-value" style="margin-top: 10px; text-align: center;">
                            <strong>Warna:</strong> <?php echo e($order->decorations['warna_tenda']); ?>
            ...
            <?php if(count($gaunImages) > 0): ?>
                <?php $hasImages = true; ?>
                <div class="info-box">
                    <span class="info-label">FOTO GAUN</span>
                    <div class="decoration-grid">
                        <?php $__currentLoopData = $gaunImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $gaunImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="decoration-item">
                                <img src="<?php echo e(public_path('storage/' . $gaunImage)); ?>" 
                                     alt="Gaun <?php echo e($index + 1); ?>" 
                                     class="decoration-image"
                                     style="max-width: 150px;">
                                <div style="font-size: 9px; color: #999; margin-top: 5px;">Gaun <?php echo e($index + 1); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <?php if(count($textDecorations) > 0): ?>
                <div class="info-box">
                    <?php $__currentLoopData = $textDecorations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="margin-bottom: 8px;">
                            <span class="info-label"><?php echo e(strtoupper($label)); ?></span>
                            <div class="info-value"><?php echo e($value); ?></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endif; ?>
    ...
    <div class="section">
        ...
        <div class="info-box" style="margin-bottom: 15px;">
            <div class="info-row">
                ...
                <div class="info-value">
                    <span
                        class="status-badge <?php echo e($order->payment_status == 'Lunas' ? 'status-lunas' : 'status-belum'); ?>">
        ...
        <?php if(is_array($order->payment_history) && count($order->payment_history) > 0): ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $order->payment_history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($payment['dp_number'] ?? 'N/A'); ?></td>
                                <td class="text-center">
                                    <?php echo e(\Carbon\Carbon::parse($payment['paid_at'])->format('d M Y')); ?></td>
                                <td class="text-right">Rp <?php echo e(number_format($payment['amount'] ?? 0, 0, ',', '.')); ?>

                                </td>
                                <td class="text-center"><?php echo e($payment['payment_method'] ?? '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
        ...
        <div class="payment-summary">
            <div class="payment-summary-row">
                ...
                <div class="payment-summary-value">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></div>
            </div>
            <div class="payment-summary-row">
            ...
            <div class="payment-summary-row highlight">
                ...
                <div class="payment-summary-value">Rp <?php echo e(number_format($order->remaining_amount, 0, ',', '.')); ?></div>
            </div>
        </div>
    </div>
    ...
    <?php if($order->notes): ?>
        <div class="notes">
            ...
            <div class="notes-content"><?php echo e($order->notes); ?></div>
        </div>
    <?php endif; ?>
    ...
    <div class="footer">
        ...
        <p style="margin-top: 8px; font-size: 9px;">Dokumen ini dibuat secara otomatis pada <?php echo e(now()->format('d F Y H:i')); ?> WIB</p>
        <p style="margin-top: 5px; font-weight: bold; color: #8b7355;">© 2026 ROROO MUA - Wedding Services</p>
    </div>
</body>

</html>
<?php /**PATH D:\Belajar\roro-wedding\resources\views/orders/pdf.blade.php ENDPATH**/ ?>