...
<aside
    ...
    <div class="p-6 border-b border-[#d4b896] text-center">
        <img src="<?php echo e(asset('logo/logo-roroo-wedding.PNG')); ?>" alt="ROROO MUA Logo"
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <a href="/dashboard"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo e(request()->is('dashboard') ? 'text-[#d4b896] border-l-4 border-[#d4b896] bg-[#d4b896]/5' : 'text-[#8b6f47] hover:bg-gray-50 hover:text-[#d4b896]'); ?>">
            <span class="material-symbols-outlined text-xl">dashboard</span>
            <span class="font-medium">Dashboard</span>
        </a>

        <a href="/clients"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo e(request()->is('clients*') ? 'text-[#d4b896] border-l-4 border-[#d4b896] bg-[#d4b896]/5' : 'text-[#8b6f47] hover:bg-gray-50 hover:text-[#d4b896]'); ?>">
            <span class="material-symbols-outlined text-xl">groups</span>
            <span class="font-medium">Clients</span>
        </a>

        <a href="/orders"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo e(request()->is('orders') && !request()->is('orders-timeline') ? 'text-[#d4b896] border-l-4 border-[#d4b896] bg-[#d4b896]/5' : 'text-[#8b6f47] hover:bg-gray-50 hover:text-[#d4b896]'); ?>">
            <span class="material-symbols-outlined text-xl">shopping_bag</span>
            <span class="font-medium">Orders</span>
        </a>

        <a href="/orders-timeline"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo e(request()->is('orders-timeline*') ? 'text-[#d4b896] border-l-4 border-[#d4b896] bg-[#d4b896]/5' : 'text-[#8b6f47] hover:bg-gray-50 hover:text-[#d4b896]'); ?>">
            <span class="material-symbols-outlined text-xl">show_chart</span>
            <span class="font-medium">Timeline Acara</span>
        </a>

        <a href="/invoices"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo e(request()->is('invoices*') ? 'text-[#d4b896] border-l-4 border-[#d4b896] bg-[#d4b896]/5' : 'text-[#8b6f47] hover:bg-gray-50 hover:text-[#d4b896]'); ?>">
...
<?php /**PATH D:\Belajar\roro-wedding\resources\views/components/sidebar.blade.php ENDPATH**/ ?>