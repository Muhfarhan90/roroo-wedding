<?php $__env->startSection('title', 'Pesanan #' . $order->order_number . ' - ROROO MUA Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold mb-2 text-black">Pesanan #<?php echo e($order->order_number); ?></h1>
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <a href="<?php echo e(route('orders.download-pdf', $order)); ?>"
            ...
            <?php if(!$existingInvoice): ?>
                ...
                <div class="mt-6 bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg">
                    ...
                    <form action="<?php echo e(route('orders.create-invoice', $order)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e(now()->format('d F Y')); ?>" readonly
                            ...
                            <div>
                                ...
                                <input type="date" id="due_date" name="due_date"
                                    value="<?php echo e(now()->addDays(7)->format('Y-m-d')); ?>" min="<?php echo e(now()->format('Y-m-d')); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-green-600">
                                        Rp
                                        <?php echo e(number_format(array_sum(array_column($order->payment_history ?? [], 'amount')), 0, ',', '.')); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-red-600">Rp
                                        <?php echo e(number_format($order->remaining_amount, 0, ',', '.')); ?></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-blue-700 mb-3">Invoice untuk pesanan ini sudah dibuat dengan nomor
                                <strong><?php echo e($existingInvoice->invoice_number); ?></strong>
                            </p>
                            <a href="<?php echo e(route('invoices.show', $existingInvoice)); ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php if(is_array($order->items) && count($order->items) > 0): ?>
                                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-4 py-3 text-sm"><?php echo e($item['name'] ?? 'N/A'); ?></td>
                                            <td class="px-4 py-3 text-sm text-center"><?php echo e($item['quantity'] ?? 0); ?></td>
                                            <td class="px-4 py-3 text-sm text-right">Rp
                                                <?php echo e(number_format($item['price'] ?? 0, 0, ',', '.')); ?></td>
                ...
                <!-- Pilihan Kustom -->
                <?php if(is_array($order->decorations) && count($order->decorations) > 0): ?>
                    <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg">
                        ...
                        <div class="space-y-6">
                            <?php if(isset($order->decorations['photo_pelaminan']) && is_string($order->decorations['photo_pelaminan'])): ?>
                                <div>
                                    ...
                                    <div class="bg-gray-100 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
                                        onclick="openImageModal('<?php echo e(asset('storage/' . $order->decorations['photo_pelaminan'])); ?>', 'Model Pelaminan')">
                            ...
                            <?php if(isset($order->decorations['photo_kain_tenda']) && is_string($order->decorations['photo_kain_tenda'])): ?>
                                <div>
                                    ...
                                    <div class="bg-gray-100 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
                                        onclick="openImageModal('<?php echo e(asset('storage/' . $order->decorations['photo_kain_tenda'])); ?>', 'Warna Kain Tenda')">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <?php for($i = 1; $i <= 3; $i++): ?>
                                            <?php if(isset($order->decorations["foto_gaun_{$i}"]) && is_string($order->decorations["foto_gaun_{$i}"])): ?>
                                                <div class="bg-gray-100 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
                                                    onclick="openImageModal('<?php echo e(asset('storage/' . $order->decorations["foto_gaun_{$i}"])); ?>', 'Gaun <?php echo e($i); ?>')">
                                                    <img src="<?php echo e(asset('storage/' . $order->decorations["foto_gaun_{$i}"])); ?>"
                                                        alt="Gaun <?php echo e($i); ?>" class="w-full h-32 object-cover">
                                                </div>
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                    </div>
                            ...
                            <?php if(isset($order->decorations['kursi_pelaminan'])): ?>
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700"><?php echo e($order->decorations['kursi_pelaminan']); ?></p>
                                </div>
                            <?php endif; ?>

                            <?php if(isset($order->decorations['warna_tenda'])): ?>
                                <div>
                                    <h3 class="text-sm font-semibold mb-2">Warna Tenda</h3>
                                    <p class="text-sm text-gray-700"><?php echo e($order->decorations['warna_tenda']); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-black"><?php echo e($order->order_number); ?></p>
                            </div>

                            <!-- Tanggal Order -->
                            <div>
                                <h3 class="text-xs font-bold text-gray-500 uppercase mb-1">Tanggal Order</h3>
                                <p class="text-sm text-black"><?php echo e($order->created_at->format('d F Y')); ?></p>
                            </div>

                            <!-- HP Pengantin Wanita -->
                            <div>
                                <h3 class="text-xs font-bold text-gray-500 uppercase mb-1">HP Pengantin Wanita</h3>
                                <a href="https://wa.me/<?php echo e($order->client->bride_phone); ?>"
                                    class="text-sm text-black hover:text-[#8b7355]"><?php echo e($order->client->bride_name); ?> -
                                    <?php echo e($order->client->bride_phone); ?></a>
                            </div>

                            <!-- HP Pengantin Pria -->
                            <div>
                                <h3 class="text-xs font-bold text-gray-500 uppercase mb-1">HP Pengantin Pria</h3>
                                <a href="https://wa.me/<?php echo e($order->client->groom_phone); ?>"
                                    class="text-sm text-black hover:text-[#8b7355]"><?php echo e($order->client->groom_name); ?> -
                                    <?php echo e($order->client->groom_phone); ?></a>
                            </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-black"><?php echo e($order->client->bride_parents ?? '-'); ?></p>
                            </div>

                            <!-- Orang Tua Pengantin Pria -->
                            <div>
                                <h3 class="text-xs font-bold text-gray-500 uppercase mb-1">Orang Tua Pengantin Pria</h3>
                                <p class="text-sm text-black"><?php echo e($order->client->groom_parents ?? '-'); ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-black">
                                        <?php echo e($order->client->akad_date ? $order->client->akad_date->format('d F Y') : '-'); ?>

                                        <?php if($order->client->akad_time): ?>
                                            - <?php echo e(date('H:i', strtotime($order->client->akad_time))); ?>

                                            <?php if($order->client->akad_end_time): ?>
                                                s/d <?php echo e(date('H:i', strtotime($order->client->akad_end_time))); ?>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="material-symbols-outlined text-[#d4b896] text-base">event</span>
                                    <span class="text-sm text-black">
                                        <?php echo e($order->client->reception_date ? $order->client->reception_date->format('d F Y') : '-'); ?>

                                        <?php if($order->client->reception_time): ?>
                                            - <?php echo e(date('H:i', strtotime($order->client->reception_time))); ?>

                                            <?php if($order->client->reception_end_time): ?>
                                                s/d <?php echo e(date('H:i', strtotime($order->client->reception_end_time))); ?>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-black"><?php echo e($order->client->event_location ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 shadow-lg">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-3 h-3 rounded-full <?php echo e($order->payment_status == 'Lunas' ? 'bg-green-500' : 'bg-yellow-500'); ?>">
                            </div>
                            <span
                                class="text-sm font-semibold <?php echo e($order->payment_status == 'Lunas' ? 'text-green-700' : 'text-yellow-700'); ?>">
                        ...
                        <div class="text-sm text-gray-600">
                            Sisa pembayaran: <span
                                class="font-bold text-lg <?php echo e($order->remaining_amount > 0 ? 'text-red-600' : 'text-green-600'); ?>">Rp
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">
                                                    <?php echo e(\Carbon\Carbon::parse($payment['paid_at'])->format('d F Y')); ?></p>
                                                <?php if(!empty($payment['notes'])): ?>
                                                    <p class="text-xs text-gray-600 mt-1"><?php echo e($payment['notes']); ?></p>
                                                <?php endif; ?>
                                                <p class="text-xs text-gray-500">
                                                    <?php echo e($payment['payment_method'] ?? 'Transfer Bank'); ?></p>
                                            </div>
    ...
    <div id="paymentModal"
        ...
        <div class="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl">
            ...
            <form action="<?php echo e(route('orders.add-payment', $order)); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Pesanan</label>
                    <div class="text-sm text-gray-600"><?php echo e($order->order_number); ?></div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-lg font-bold text-red-600">Rp
                        <?php echo e(number_format($order->remaining_amount, 0, ',', '.')); ?></div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="amount" name="amount"
                        ...
                        placeholder="0" min="0" max="<?php echo e($order->remaining_amount); ?>" required>
    ...
    <script>
        ...
        function openPaymentModal() {
            const paymentHistory = <?php echo json_encode($order->payment_history ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/orders/show.blade.php ENDPATH**/ ?>