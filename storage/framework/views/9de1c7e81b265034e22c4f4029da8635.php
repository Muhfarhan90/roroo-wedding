...
<?php $__env->startSection('title', 'Profile - ROROO MUA Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gradient-to-br from-[#faf9f7] to-white p-4 sm:p-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-lg">
                <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="p-6 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="business_name" value="<?php echo e(old('business_name', $profile->business_name)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="owner_name" value="<?php echo e(old('owner_name', $profile->owner_name)); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                                    required>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', $profile->email)); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                                    required>
                            </div>
                            <div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                                required><?php echo e(old('address', $profile->address)); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="bankAccounts" class="space-y-3">
                            <?php if($profile->banks && count($profile->banks) > 0): ?>
                                <?php $__currentLoopData = $profile->banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bank-account bg-gray-50 rounded-lg p-4">
                                        <div class="flex items-start justify-between mb-3">
                                            <span class="text-sm font-medium text-gray-700">Rekening #<?php echo e($index + 1); ?></span>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            <div>
                                                ...
                                                <input type="text" name="banks[<?php echo e($index); ?>][bank_name]"
                                                    value="<?php echo e(old("banks.{$index}.bank_name", $bank['bank_name'])); ?>"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="banks[<?php echo e($index); ?>][account_number]"
                                                    value="<?php echo e(old("banks.{$index}.account_number", $bank['account_number'])); ?>"
                                                    class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                                                    placeholder="1234567890" required>
                                            </div>
                                            <div>
                                                <label class="block text-xs font-medium text-gray-600 mb-1">Atas Nama</label>
                                                <input type="text" name="banks[<?php echo e($index); ?>][account_holder]"
                                                    value="<?php echo e(old("banks.{$index}.account_holder", $bank['account_holder'])); ?>"
                                                    class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="social_media[instagram]"
                                    value="<?php echo e(old('social_media.instagram', $profile->social_media['instagram'] ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                            ...
                            <div>
                                ...
                                <input type="text" name="social_media[facebook]"
                                    value="<?php echo e(old('social_media.facebook', $profile->social_media['facebook'] ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                            ...
                            <div>
                                ...
                                <input type="text" name="social_media[tiktok]"
                                    value="<?php echo e(old('social_media.tiktok', $profile->social_media['tiktok'] ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                                    placeholder="@username">
                            </div>
                            <div>
                                ...
                                <input type="text" name="social_media[whatsapp]"
                                    value="<?php echo e(old('social_media.whatsapp', $profile->social_media['whatsapp'] ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="social_media[website]"
                                    value="<?php echo e(old('social_media.website', $profile->social_media['website'] ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4b896]"
                            placeholder="Ceritakan tentang bisnis Anda..."><?php echo e(old('description', $profile->description)); ?></textarea>
                    </div>
    ...
    <script>
        let bankCounter = <?php echo e(count($profile->banks ?? [])); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/profile/index.blade.php ENDPATH**/ ?>