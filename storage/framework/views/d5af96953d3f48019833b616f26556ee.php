<?php $__env->startSection('title', 'Daftar Pesanan & Manajemen - ROROO MUA Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="bg-white border-2 border-[#d4b896] rounded-xl p-3 sm:p-6 mb-4 sm:mb-6 shadow-lg relative z-10">
            <form method="GET" action="<?php echo e(route('orders.index')); ?>" id="filterForm">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-2">
                    ...
                    <div class="relative lg:col-span-5">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari pesanan..."
        ...
        <script>
            ...
            function exportPDF() {
                ...
                window.open('<?php echo e(route('orders.index')); ?>?export=pdf&' + params, '_blank');
            }
        </script>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-2 sm:px-6 py-2 sm:py-4 text-center">
                                    <div class="text-xs sm:text-sm text-black">
                                        <?php echo e($loop->iteration + ($orders->currentPage() - 1) * $orders->perPage()); ?></div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm font-medium text-black"><?php echo e($order->order_number); ?></div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm font-medium text-black"><?php echo e($order->client->bride_name); ?>

                                        &
                                        <?php echo e($order->client->groom_name); ?></div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm text-black">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/orders/index.blade.php ENDPATH**/ ?>