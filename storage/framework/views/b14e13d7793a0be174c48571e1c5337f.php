<?php $__env->startSection('title', 'Invoice History - ROROO MUA Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="bg-white border-2 border-[#d4b896] rounded-xl p-3 sm:p-6 mb-4 sm:mb-6 shadow-lg relative z-10">
            <form method="GET" action="<?php echo e(route('invoices.index')); ?>" id="filterForm">
                    ...
                    <div class="grid grid-cols-3 gap-2 lg:col-span-7 lg:grid-cols-7">
                        ...
                        <div
                            ...
                            <select name="sort"
                                ...
                                <option value="client_name" <?php echo e(request('sort') == 'client_name' ? 'selected' : ''); ?>>Nama
                                </option>
                                <option value="issue_date" <?php echo e(request('sort') == 'issue_date' ? 'selected' : ''); ?>>Tanggal
                                </option>
                            </select>
                        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm font-medium text-black"><?php echo e($invoice->invoice_number); ?>
                                    ...
                                    ?>
                                    <?php if($dpType): ?>
                                        <div class="text-[10px] sm:text-xs text-gray-500 mt-1"><?php echo e($dpType); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm font-medium text-black">
                                        <?php echo e($invoice->order->client->bride_name); ?> &
                                        <?php echo e($invoice->order->client->groom_name); ?></div>
                                    <div class="text-[10px] sm:text-xs text-gray-500 mt-1">
                                        <?php echo e($invoice->order->order_number); ?></div>
                                </td>
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    <div class="text-xs sm:text-sm text-black">
                                        <?php echo e(\Carbon\Carbon::parse($invoice->issue_date)->format('M d, Y')); ?>
                                ...
                                <td class="px-2 sm:px-6 py-2 sm:py-4">
                                    ...
                                    <?php elseif($invoice->status == 'Partial'): ?> bg-yellow-100 text-yellow-800
    ...
    <script>
        ...
        function exportPDF() {
            ...
            window.open('<?php echo e(route('invoices.index')); ?>?export=pdf&' + params, '_blank');
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/invoices/index.blade.php ENDPATH**/ ?>