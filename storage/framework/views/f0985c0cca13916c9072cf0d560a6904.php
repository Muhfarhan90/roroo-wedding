<?php $__env->startSection('title', 'Ubah Pesanan #' . $order->order_number . ' - ROROO MUA Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gray-50 text-black p-4 sm:p-6 md:p-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl md:text-3xl font-bold mb-2 text-black">Ubah Pesanan #<?php echo e($order->order_number); ?></h1>
            <p class="text-sm md:text-base text-gray-600">Edit informasi pesanan untuk klien.</p>
        </div>

        <form action="<?php echo e(route('orders.update', $order)); ?>" method="POST" enctype="multipart/form-data" id="orderForm">
            <?php echo csrf_field(); ?>
                        ...
                        <select name="client_id" id="client_id" required
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($client->id); ?>" data-location="<?php echo e($client->event_location); ?>"
                                    <?php echo e($order->client_id == $client->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white border-2 border-[#d4b896] rounded-xl p-6 mb-6 shadow-lg">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <?php if(isset($order->decorations['photo_pelaminan']) && $order->decorations['photo_pelaminan']): ?>
                            <div class="mb-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span id="pelaminan_filename"
                                class="text-sm text-gray-500"><?php echo e(isset($order->decorations['photo_pelaminan']) && $order->decorations['photo_pelaminan'] ? 'File sudah ada' : 'No file chosen'); ?></span>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="decorations[kursi_pelaminan]"
                            value="<?php echo e(old('decorations.kursi_pelaminan', $order->decorations['kursi_pelaminan'] ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <?php if(isset($order->decorations['photo_kain_tenda']) && $order->decorations['photo_kain_tenda']): ?>
                            <div class="mb-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span id="kain_filename"
                                class="text-sm text-gray-500"><?php echo e(isset($order->decorations['photo_kain_tenda']) && $order->decorations['photo_kain_tenda'] ? 'File sudah ada' : 'No file chosen'); ?></span>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="decorations[warna_tenda]"
                            value="<?php echo e(old('decorations.warna_tenda', $order->decorations['warna_tenda'] ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <?php for($i = 1; $i <= 3; $i++): ?>
                                <div>
                                    <?php if(isset($order->decorations["foto_gaun_$i"]) && $order->decorations["foto_gaun_$i"]): ?>
                                        <div class="mb-3">
                                            <img src="<?php echo e(asset('storage/' . $order->decorations["foto_gaun_$i"])); ?>"
                                                alt="Foto Gaun <?php echo e($i); ?>"
                                                class="w-full h-48 object-cover rounded-lg border-2 border-gray-200"
                                                id="gaun_<?php echo e($i); ?>_preview">
                                            <p class="text-xs text-gray-500 mt-1">Foto <?php echo e($i); ?> sudah ada</p>
                                        </div>
                                    <?php else: ?>
                                        <div id="gaun_<?php echo e($i); ?>_preview_container" class="mb-3 hidden">
                                            <img src="" alt="Preview" id="gaun_<?php echo e($i); ?>_preview"
                                                class="w-full h-48 object-cover rounded-lg border-2 border-gray-200">
                                        </div>
                                    <?php endif; ?>
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span id="gaun_<?php echo e($i); ?>_filename"
                                            class="text-sm text-gray-500"><?php echo e(isset($order->decorations["foto_gaun_$i"]) && $order->decorations["foto_gaun_$i"] ? 'File sudah ada' : "Foto Gaun $i"); ?></span>
                                    </div>
                                    <input type="file" id="foto_gaun_<?php echo e($i); ?>"
                                        name="decorations[foto_gaun_<?php echo e($i); ?>]" class="hidden"
                                        accept="image/*"
                                        onchange="updateFileName(this, 'gaun_<?php echo e($i); ?>_filename', 'gaun_<?php echo e($i); ?>_preview')">
                                </div>
                            <?php endfor; ?>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4" placeholder="Tulis permintaan tambahan di sini..."
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none"><?php echo e(old('notes', $order->notes)); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <select name="payment_status" required
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#d4b896] focus:outline-none">
                            <option value="Belum Lunas" <?php echo e($order->payment_status == 'Belum Lunas' ? 'selected' : ''); ?>>
                                Belum Lunas</option>
                            <option value="Lunas" <?php echo e($order->payment_status == 'Lunas' ? 'selected' : ''); ?>>Lunas
                            </option>
                        </select>
                    </div>
                </div>
    ...
    <script>
        ...
        // Load existing items
        const existingItems = <?php echo json_encode($order->items ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/orders/edit.blade.php ENDPATH**/ ?>