<?php $__env->startSection('content'); ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8" id="invoicePreview">
                        ...
                        <div class="flex justify-between items-start mb-6 pb-6 border-b border-[#e8d5c4]">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($invoice->invoice_number); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <p class="font-semibold text-gray-900"><?php echo e($invoice->order->client->bride_name); ?> &
                                    <?php echo e($invoice->order->client->groom_name); ?></p>

                                <p class="text-sm text-gray-600"><strong>HP Pengantin Wanita:</strong>
                                    <?php echo e($invoice->order->client->bride_phone); ?></p>
                                <?php if($invoice->order->client->groom_phone): ?>
                                    <p class="text-sm text-gray-600"><strong>HP Pengantin Pria:</strong>
                                        <?php echo e($invoice->order->client->groom_phone); ?></p>
                                <?php endif; ?>
                                ...
                                <p class="text-sm text-gray-600"><strong>Alamat Venue:</strong>
                                    <?php echo e($invoice->order->client->event_location ?? '-'); ?></p>
                            </div>
                            <div class="text-right">
                                ...
                                <div class="mb-1">
                                    ...
                                    <span
                                        class="font-semibold text-gray-900"><?php echo e(\Carbon\Carbon::parse($invoice->issue_date)->format('M d, Y')); ?></span>
                                </div>
                                <?php
                                    $paymentHistoryCheck = $invoice->order->payment_history ?? [];
                                    $totalPaidCheck = 0;
                                ...
                                <div class="mb-1">
                                    ...
                                    <?php else: ?>
                                        <span id="previewDueDate"
                                            class="font-semibold text-gray-900"><?php echo e(\Carbon\Carbon::parse($invoice->due_date)->format('M d, Y')); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div>
                                    <span class="text-sm text-gray-600">ID Pesanan:</span>
                                    <span class="font-semibold text-gray-900"><?php echo e($invoice->order->order_number); ?></span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-80">
                                    <div class="flex justify-between text-sm py-2">
                                        ...
                                        <span class="text-gray-900 font-semibold">Rp
                                            <?php echo e(number_format($invoice->order->total_amount, 0, ',', '.')); ?></span>
                                    </div>
                                    ...
                                    <?php $__currentLoopData = $paymentHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div
                                            class="flex justify-between text-sm py-2 <?php if($loop->last): ?> border-b-2 border-[#e8b896] <?php endif; ?>">
                                            <span class="text-gray-600"><?php echo e($payment['dp_number'] ?? 'DP'); ?></span>
                                            <span class="text-gray-900 font-semibold">Rp
                                                <?php echo e(number_format($payment['amount'] ?? 0, 0, ',', '.')); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex justify-end">
                                    <div class="w-80 flex justify-between">
                                        ...
                                        <span class="text-[#f57c00] font-bold text-sm">Rp
                                            <?php echo e(number_format($invoice->total_amount - $totalPaid, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $paymentHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 bg-gray-50 rounded-lg border-l-4 border-[#d4b896]">
                                        <div class="flex justify-between items-start mb-1">
                                            <span
                                                class="text-sm font-semibold text-gray-900"><?php echo e($payment['dp_number'] ?? 'DP'); ?></span>
                                            <span class="text-sm font-semibold text-[#d4b896]">Rp
                                                <?php echo e(number_format($payment['amount'] ?? 0, 0, ',', '.')); ?></span>
                                        </div>
                                        <p class="text-xs text-gray-600">
                                            <?php echo e(\Carbon\Carbon::parse($payment['paid_at'] ?? now())->format('M d, Y')); ?> via
                                            <?php echo e($payment['payment_method'] ?? 'Transfer Bank'); ?>
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            window.location.href = '<?php echo e(route('invoices.download-pdf', $invoice->id)); ?>?due_date=' + dueDate;
        }
    </script>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Belajar\roro-wedding\resources\views/invoices/show.blade.php ENDPATH**/ ?>